...
################################################################################
# from: https://gist.github.com/BoltzmannBrain/ca00cd605d830c761ce0
...
main <- function(pathToNAB, algorithmName, skipFiles=list()) {
  ...
  windows = fromJSON(paste(pathToNAB, "labels/combined_windows_HTM_multiv.json", sep='/'))
...
pathToNAB = "Nextcloud/Leuphana/Masterthesis/Anomaly_Detection/NAB"
skipFiles = list()
